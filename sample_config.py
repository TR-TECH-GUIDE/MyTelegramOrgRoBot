...
class Config:
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/MyTelegramOrgslbot")
    ...
    # please reopen
    # https://github.com/TR-TECH-GUIDE/MyTelegramOrgRoBot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/MyTelegramOrgslbot"
    )
    #
